...
// todo: allow switching these at runtime based on the compiler being used for cusd.cpp.
#define GCC_XFORM_CACHE_SIZE 6
#define CLANG_XFORM_CACHE_SIZE 8
...
#define DEFINE_SLICE_FNS(NAME, ITEM_TYPE)                                                                              \
    ...
    DEFINE_OPAQUE(cusd_GeomXformCache, CLANG_XFORM_CACHE_SIZE)
    ...
    cusd_GeomXformCache cusd_GeomXformCache_new(void);
    ...
    bool cusd_Prim_get_parent(const cusd_Prim *prim, cusd_Prim * parent);
